...
public class IndexBuilder {
    ...
    public static List<Field> getFields() {
        synchronized (Field.class) {
            if (fields == null) {
                fields = RepositoryMapper.fieldRepo.findAll();
            }
            return fields;
        }
    }
    ...
    public static void build(Site site) {
        RepositoryMapper.lemmaRepo.deleteAllInBatchBySite(site);
    ...
    private void buildIndex() {
        ...
        for (Page page : pages) {
            ...
            Page pag;
            pag = RepositoryMapper.pageRepo.findById(page.getId()).orElse(null);
            if (pag == null) {
                continue;
            }
    ...
    public void saveLemmasAndIndices() {
        ...
        synchronized (Lemma.class) {
            RepositoryMapper.lemmaRepo.saveAllAndFlush(lemmaCollection);
        }
    ...
    private void saveIndicesByMultipleInsert() {
        ...
        synchronized (Index.class) {
            RepositoryMapper.indexImplRepo.insertIndexList(siteName, siteIndices);
        }
    }
}
