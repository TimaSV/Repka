...
import main.service.builders.SiteBuilder;
...
public class StatisticsResponse extends Response {
    ...
    static class Statistics {
        ...
        public Statistics() {
            ...
            List<Site> sites = StatisticsInitializer.siteRepo.findAll().stream()
    ...
    static class TotalStatistics {
        ...
        public TotalStatistics() {
            int siteCount = StatisticsInitializer.siteRepo.countByType(Site.INDEXED) +
                    StatisticsInitializer.siteRepo.countByType(Site.FAILED);
            setSites(siteCount);

            List<Site> indexedSites = StatisticsInitializer.siteRepo.findAllByType(Site.INDEXED);
            setPages(StatisticsInitializer.pageRepo.countBySites(indexedSites));
            setLemmas(StatisticsInitializer.lemmaRepo.countBySites(indexedSites));
    ...
    static class DetailedStatistics {
        ...
        public DetailedStatistics(Site site) {
            ...
            pages = StatisticsInitializer.pageRepo.countBySite(site);
            lemmas = StatisticsInitializer.lemmaRepo.countBySite(site);
        }
    }
}
